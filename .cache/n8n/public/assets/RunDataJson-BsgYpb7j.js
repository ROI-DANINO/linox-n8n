const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-BwVIOF0o.js","assets/index-0vi2zwei.js","assets/index-BnmK7yJz.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aP as useNDVStore, r as ref, g2 as useElementSize, x as computed, gB as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dh as defineAsyncComponent, dg as Suspense, gC as VueJsonPretty, gw as __unplugin_components_0, n as normalizeClass, gx as MappingPill, f$ as Draggable, aL as __vitePreload, gy as shorten, gA as getMappedExpression, bg as useExternalHooks, aA as useTelemetry, gD as isString, gE as nonExistingJsonPath, _ as _export_sfc } from "./index-0vi2zwei.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-BwVIOF0o.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
